...
class Actor extends React.Component {
        ...
        <div className="layout-single__primary__infos">
          ...
          <div className="layout-single__left-main">
            {actorBirthday && birthPlace && (
              <p>
                <span role="img" aria-label="emoji poussin">
                  🐣
                </span>{" "}
                {actorBirthday} - {birthPlace}
              </p>
            ...
            {actorDetails.deathday && (
              <p>
                <span role="img" aria-label="emoji cerceuil">
                  ⚰️
                </span>{" "}
                {actorDeathday}
              </p>
            ...
            {actorDetails.biography && (
              <p className="textAlignLeft longText">
                <span role="img" aria-label="emoji style plume">
                  🖋
                </span>{" "}
                {actorDetails.biography}
              </p>
  ...
  renderActorMovies = (actorMovies) => {
    const sortedActorMovies = actorMovies.cast
      .sort((prevMovie, nextMovie) => (prevMovie.vote_average > nextMovie.vote_average ? -1 : 1))
      .slice(0, 12);
    return (
